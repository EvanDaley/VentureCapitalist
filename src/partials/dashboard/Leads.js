          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="flex-grow flex items-center border-b border-gray-100 text-sm py-2">
                <div className="flex-grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-gray-800 hover:text-gray-900" href="#0">Uncle Vinnie</a> wants to become an <a className="font-medium text-gray-800" href="#0">Investor</a></div>
            ...
            <li className="flex px-2">
              ...
              <div className="flex-grow flex items-center text-sm py-2">
                <div className="flex-grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-gray-800 hover:text-gray-900" href="#0">Patrick Sullivan</a> posted about the <a className="font-medium text-gray-800" href="#0">Lemonade Stand</a></div>
                  <div className="flex-shrink-0 self-end ml-2">
                    <a className="font-medium text-indigo-500 hover:text-indigo-600" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              ...
              <div className="flex-grow flex items-center border-b border-gray-100 text-sm py-2">
                <div className="flex-grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-gray-800 hover:text-gray-900" href="#0">4+</a> users have subscribed to <a className="font-medium text-gray-800" href="#0">Newsletter #1</a></div>
                  <div className="flex-shrink-0 self-end ml-2">
                    <a className="font-medium text-indigo-500 hover:text-indigo-600" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
            ...
            <li className="flex px-2">
              ...
              <div className="flex-grow flex items-center text-sm py-2">
                <div className="flex-grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-gray-800" href="#0">Franklin G</a> wants to become an <a className="font-medium text-gray-800 hover:text-gray-900" href="#0">Investor</a></div>
                  <div className="flex-shrink-0 self-end ml-2">
                    <a className="font-medium text-indigo-500 hover:text-indigo-600" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
